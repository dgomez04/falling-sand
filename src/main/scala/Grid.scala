...
case class Grid(val width: Int, val height: Int, cells: mutable.ArrayBuffer[mutable.ArrayBuffer[Option[Particle]]], buffer: mutable.Set[Particle] = mutable.Set.empty[Particle]) {
    ...
    def buffer_reset() : Unit = buffer.clear()
} 
